...
```{r}
# df <- df_mutations_F1CDx_withVEPannovar_cos_simp
# df <- df_mutations_NCC_withVEPannovar_cos_simp
# df <- df_DFCI_withVEPannovar_variant_cos_simp 
# df <- df_MSK_withVEPannovar_variant_cos_simp
# df <- df_DUKE_withVEPannovar_variant_cos
