...
grid::grid.text(paste("3 groups wt change: all genes", sep = ""), .5, .85, gp = grid::gpar(cex = 2))
dev.off()
```
...
m <- metacont(KOdriver_mt_cases, mean_KOdriver_mt, sd_KOdriver_mt,
              ...
              sm = "MD")
forest(m, layout = "JAMA", xlim = c(-0.8,0.8), at = c(-0.8, -0.6, -0.4, -0.2, 0, 0.2, 0.4, 0.6, 0.8))
grid::grid.text(paste("3 groups KOgene mt vs wt: all genes", sep = ""), .5, .85, gp = grid::gpar(cex = 2))
...
grid::grid.text(paste("3 groups otherdriver mt vs wt: all genes", sep = ""), .5, .85, gp = grid::gpar(cex = 2))
dev.off()
```
